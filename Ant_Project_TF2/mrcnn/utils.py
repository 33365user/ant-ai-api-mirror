...
class Dataset(object):
    ...
    def load_image(self, image_id):
        ...
        dtype = image.dtype
        ###################### My Addition to check for TIFF or TIF files ######################
        # If image is Uint16
        if (dtype == 'uint16'):
...
#########################################################################################################
######## STARTING CODE FOR CONFUSION MATRIX PERSONAL ADDITION HERE #################################
#########################################################################################################
...
def get_new_fig(fn, figsize=[18,18]):
    """ Init graphics """
...
def plot_confusion_matrix_from_data(y_test, predictions, columns=None, annot=True, cmap="Oranges",
      fmt='.2f', fz=11, lw=0.5, cbar=False, figsize=[196,196], show_null_values=0, pred_val_axis='lin'):
    """
    ...
    #plot
    print('The value of column is: ', columns)
