...
def mrcnn_class_loss_graph(target_class_ids, pred_class_logits,
                           active_class_ids, class_weight = CLASS_WEIGHT):
...
class MaskRCNN(object):
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        hist = self.keras_model.fit_generator(train_generator, 
                                    ...
                                    workers=1, #modified from workers to 1 (besuace the training stucks in epoch 1 or 2 or 3) 
                                    use_multiprocessing=False, #modified from true to false (training stucks in epoch 1 or 2 or 3) 
