...
class AntsConfig(Config):
    ...
    #NUM_CLASSES = 1 + 2  # background + 2 invasive-ant-types (incl. resembling ants) + 1 Non-Target-Ants
    NUM_CLASSES = 1 + 3  # background + invasive-ant-types (incl. resembling ants)+ Other invasive ants + 1 Non-Target-Ants
...
class AntDetector(utils.Dataset):
       ...
       generate masks for the annotated ants in the images files and allocate corresponding class to it.
        ...
        def load_dataset(self, dataset, is_train=True):
            ...
            self.add_class("dataset", 1, "Lepisiota_frauenfeldi")
        ...
        def load_mask(self, image_id):
            ...
            for i in range(len(boxes)):
                ...
                if(box[4] == 'Lepisiota_frauenfeldi'):
                    masks[row_s:row_e, col_s:col_e, i] = 1
                    class_ids.append(self.class_names.index('Lepisiota_frauenfeldi'))
                elif(box[4] == 'Anoplolepis_gracilipes' or box[4] == 'Linepithema_humile' or box[4] == 'Solenopsis_geminata' or box[4] == 'Pheidole_megacephala' or box[4] =='Solenopsis_invicta' or box[4] =='Wasmannia_auropunctata'):
