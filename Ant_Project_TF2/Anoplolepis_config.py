...
class AntsConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # background + 1 invasive-ant-types (incl. resembling ants) + all other target ants + 1 Non-Target-Ants
       ...
       generate masks for the annotated ants in the images files and allocate corresponding class to it.
        ...
        def load_mask(self, image_id):
            ...
            for i in range(len(boxes)):
                ...
                if(box[4] == 'Anoplolepis_gracilipes'):
                    masks[row_s:row_e, col_s:col_e, i] = 1
                    class_ids.append(self.class_names.index('Anoplolepis_gracilipes'))
                elif(box[4] == 'Lepisiota_frauenfeldi' or box[4] == 'Linepithema_humile' or box[4] == 'Solenopsis_geminata' or box[4] == 'Pheidole_megacephala' or box[4] =='Solenopsis_invicta' or box[4] =='Wasmannia_auropunctata'):
