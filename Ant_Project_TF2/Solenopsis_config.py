...
class AntDetector(utils.Dataset):
       ...
       generate masks for the annotated ants in the images files and allocate corresponding class to it.
        ...
        def load_dataset(self, dataset, is_train=True):
            ...
            self.add_class("dataset", 1, "Solenopsis_Target")
        ...
        def load_mask(self, image_id):
            ...
            for i in range(len(boxes)):
                ...
                if(box[4] == 'Solenopsis_geminata' or box[4] == 'Solenopsis_invicta'):
                    masks[row_s:row_e, col_s:col_e, i] = 1
                    class_ids.append(self.class_names.index('Solenopsis_Target'))
                elif(box[4] == 'Anoplolepis_gracilipes' or box[4] == 'Lepisiota_frauenfeldi' or box[4] == 'Linepithema_humile' or box[4] == 'Pheidole_megacephala' or box[4] =='Wasmannia_auropunctata'):
